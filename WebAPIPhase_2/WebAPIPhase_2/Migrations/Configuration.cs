namespace WebAPIPhase_2.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebAPIPhase_2.Models.WebAPIPhase_2Context>
    {
        ...
        protected override void Seed(WebAPIPhase_2.Models.WebAPIPhase_2Context context)
        {
            ...
            context.Products.AddOrUpdate(x => x.ProductId, new Product { Name = "Nvidia Titan X", InventoryCount = 100, Price = 500, ProductId = 1, CreatedDate = DateTime.Today, LastModifiedDate = DateTime.Today, CategoryId = 1, ManufacturerId = 1 });
            context.Products.AddOrUpdate(x => x.ProductId, new Product { Name = "AMD 5GHz 8-Core Processor", InventoryCount = 100, Price = 250, ProductId = 2, CreatedDate = DateTime.Today, LastModifiedDate = DateTime.Today, CategoryId = 2, ManufacturerId = 2 });
